...
insert  into `devicemgt_k_staffworkinfo`(`id`,`userid_id`,`date`,`checkin`,`checkout`,`shifting`) values (1,2,'2015-05-22','in hehe','out hehe','');
