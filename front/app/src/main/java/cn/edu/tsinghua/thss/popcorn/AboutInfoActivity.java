...
import cn.edu.tsinghua.thss.popcorn.update.DownLoadManager;
...
public class AboutInfoActivity extends Activity {
    ...
    private void onOfficialWebsiteClick(View v) {
        String url = Config.WILL_WINGS_ORG_WEBSITE;
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setData(Uri.parse(url));
        startActivity(intent);
    }

    @OnClick(R.id.check_for_update_ll)
    private  void onCheckForUpdateClick(View v) {
        try {
